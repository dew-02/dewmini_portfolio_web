...
const projects = [
  {
    ...
    github:
      "https://github.com/dew-02/university_internship_career_management_system.git",
  ...
  },
  {
    ...
    github:
      "https://github.com/dew-02/facilities_halls_booking_system.git",
  ...
  },
  {
    ...
    image: project2,
    description:
      "A full-stack online medical service portal designed to streamline healthcare workflows by enabling patients to book appointments, manage medical records, and interact with healthcare providers through a centralized dashboard.",
  ...
  },
  {
    ...
    github:
      "https://github.com/dew-02/learn-languages-app-mad_lab_exam_2.git",
    tech: ["Kotlin", "Android"],
    type: "Mobile",
  },
];
      ...
      >
        <div className="page-shell max-w-4xl text-center">
          ...
          <h1 className="section-title mt-6">
            Projects with purpose and polish.
          </h1>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="mt-4 text-sm leading-7 text-slate-300">
                    {expanded[index]
                      ? project.description
                      : getShortText(project.description)}
                  </p>

                  <button
                    onClick={() => toggleReadMore(index)}
                    className="mt-2 text-sm font-semibold text-blue-300 hover:text-purple-300"
                  >
