...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-gradient-to-r from-blue-950 via-black to-gray-900 fixed top-0 left-0 z-50 shadow-lg">
      <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          ...
          />
          <span className="text-2xl font-bold transition-colors duration-300 group-hover:text-blue-400">
            <span className="text-white">Dewmini</span>{" "}
            <span className="text-white">Chalakshana</span>
          </span>
          {/* underline highlight */}
          <span className="block h-1 w-0 bg-black-200 transition-all duration-300 group-hover:w-full"></span>
        </a>
